...
class SwitcherSideMobile extends StatefulWidget {
  const SwitcherSideMobile({
    key,
...
class _SwitcherSideState extends State<SwitcherSideMobile> {
  @override
  Widget build(BuildContext context) {
    final size = MediaQuery.of(context).size;

    return Align(
      alignment: Alignment(0.0, widget._animation.value),
      child: Container(
